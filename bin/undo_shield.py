...
# ── Module-level constants (safe at import time) ──────────────────────────────
...
def main() -> None:
    ...
    lines += ["", "This operation cannot be undone."]
    if exit_code == 2:
    ...
    lines += ["", "  (To bypass: set DG_UNDO_SHIELD=0 in your environment)"]
