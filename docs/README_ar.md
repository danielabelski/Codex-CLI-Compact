...
أُجريت المقارنات على أكثر من 80 طلبًا فعليًا على تطبيق متكامل:

| المقياس | بدون GrapeRoot | مع GrapeRoot |
|---------|:--------------:|:------------:|
| متوسط التكلفة لكل طلب | $0.46 | **$0.27** |
| متوسط عدد الجولات | 16.8 | **10.3** |
| متوسط وقت الاستجابة | 186s | **134s** |
| الجودة (بالتقييم) | 82.7/100 | **87.1/100** |

> تفوّق في التكلفة على **16 من أصل 20** طلبًا. الجودة متساوية أو أفضل في جميع مستويات التعقيد.
