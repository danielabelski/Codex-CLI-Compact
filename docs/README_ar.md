...
أُجريت المقارنات على قاعدة كود Python مؤلفة من 7,762 ملفًا (Sentry)، بواقع 30 طلبًا من مهام هندسية حقيقية:

| المقياس | بدون GrapeRoot | مع GrapeRoot | الوفورات |
|---------|:--------------:|:------------:|:--------:|
| تكلفة الطلب الواحد | $0.77 | **$0.44** | **أقل بنسبة 43%** |
| عدد الرموز المقروءة لكل دورة | ~307K | **~76K** | **أقل بنسبة 75%** |
| متوسط الدورات لكل مهمة | 16.8 | **10.3** | **أقل بنسبة 39%** |
| الجودة (بالتقييم) | 78.6 / 100 | **78.7–79.4 / 100** | مساوية أو أفضل |
| القيمة (الجودة مقابل الدولار) | 1.0× | **1.75×** | **أعلى بنسبة 75%** |

### الوفورات حسب نوع المهمة

يقرأ الرسم البياني فقط المقطع ذا الصلة من كل ملف، لا الملف بأكمله. تتراكم الوفورات طوال الجلسة: فالرمز المُوفَّر في الدورة 3 من جلسة مدتها 20 دورة يُجنّب أيضًا إعادة الفوترة للذاكرة المؤقتة في كل دورة لاحقة.

| نوع المهمة | الرموز المقروءة الموفَّرة | تخفيض التكلفة |
|------------|:------------------------:|:-------------:|
| بحث بسيط / ملف واحد | 50–60% | 5–10% |
| إصلاح الأخطاء والتشخيص | 65–75% | 15–25% |
| إعادة الهيكلة (متعددة الملفات) | 75–80% | 25–35% |
| التنقل في قاعدة كود كبيرة (7k+ ملف) | **80%+** | **حتى 47%** |

> في قواعد الكود الكبيرة، تنخفض قراءات الرموز **بنسبة 68–75% لكل جلسة**. تبقى الجودة مساوية أو تتحسن — لأن الذكاء الاصطناعي يحصل على الملفات الصحيحة بدلًا من التخمين.
