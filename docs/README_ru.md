...
Протестировано на 80+ промптах в реальном full-stack приложении:

| Метрика | Без GrapeRoot | С GrapeRoot |
|---------|:-------------:|:-----------:|
| Средняя стоимость промпта | $0.46 | **$0.27** |
| Среднее число итераций | 16.8 | **10.3** |
| Среднее время ответа | 186 сек. | **134 сек.** |
| Качество (оценка) | 82.7/100 | **87.1/100** |

> Выигрыш по стоимости на **16 из 20** промптов. Качество равное или выше на каждом уровне сложности.
